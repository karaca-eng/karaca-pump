...
class MarketRadar:
    ...
    def check_logic(self, symbol, now):
        ...
        # 3 Dakikalık Analiz (Tetikleyici)
...
st.markdown("""
    ...
    /* Balina Satır Renkleri (Şeffaf Alım-Satım) */
        ...
        with radar.lock:
            ...
            if display_data:
                ...
                for row in display_data:
                    ...
                    # Balina Satırı Renklendirme Mantığı
                    row_class = ""
                    whale_icon = ""
                    if row.get('Whale'):
                        whale_icon = " 🐳"
